...
## Folder Contents (Moved 2026-08-14)
...
- `docs/inspiration-reports/yaml-to-rust-agentsdk/adr-0004-glyphnova-ui-control-plane.yml` — projection-layer + multi-zoom principles.
- `opencode/plans/PHASE-TIMELINE.md` — phase roadmap.
- `opencode/plans/AGENT-QUEUE-ANALYSIS.md` — UI ownership boundary.
- `opencode/plans/P2P-GAMIFICATION-VISION.md` — swarm + marketplace layer.
- `docs/ui-implications/aggregate/REPORT.md` — synthesis of what each repo contributes to the UI.
- Per-repo `docs/ui-implications/*/REPORT.md` — evidence and exact quotes.
