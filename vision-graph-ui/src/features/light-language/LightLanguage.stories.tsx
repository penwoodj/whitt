...
const meta = {
  title: 'Features/LightLanguage/LightLanguage',
...
export const LGT01TokenTableStates: Story = {
  name: 'slice03 -- LGT-01 token table states',
  render: () => (
...
export const LGT02AmplitudeCurve: Story = {
  name: 'slice03 -- LGT-02 amplitude curve',
  render: () => {
    const mockAnalyser = {
...
export const LGT03SilenceStillness: Story = {
  name: 'slice03 -- LGT-03 silence stillness',
  render: () => {
    const mockAnalyser = {
      context: { sampleRate: 44100 },
      frequencyBinCount: 128,
...
export const VOX02RecordingColorShift: Story = {
  name: 'slice03 -- VOX-02 recording color shift',
  render: () => (
...
export const VOX03VolumeBreathing: Story = {
  name: 'slice03 -- VOX-03 volume breathing',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const EXP04BarOfLight: Story = {
  name: 'slice03 -- EXP-04 bar of light',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const EXP08BarBreathesTooltipClosed: Story = {
  name: 'slice03 -- EXP-08 bar breathes tooltip-closed',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const LGT08BarRestState: Story = {
  name: 'slice03 -- LGT-08 bar rest state',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const EXP02BallBecomesHalo: Story = {
  name: 'slice03 -- EXP-02 ball becomes halo',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const GRP08GroupingHalo: Story = {
  name: 'slice03 -- GRP-08 grouping halo',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const LGT05HaloGeometry: Story = {
  name: 'slice03 -- LGT-05 halo geometry',
  render: () => (
    <div style={{ display: 'flex', gap: '16px', padding: '16px' }}>
      <div>
        <div>Modal Halo</div>
...
export const EXE11EdgesBreatheExecuting: Story = {
  name: 'slice03 -- EXE-11 edges breathe executing',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const EXE12BorderAnimationEventual: Story = {
  name: 'slice03 -- EXE-12 border animation eventual',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const EXE14MorphLoader: Story = {
  name: 'slice03 -- EXE-14 morph loader',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const LGT04MorphCadence: Story = {
  name: 'slice03 -- LGT-04 morph cadence',
  render: () => (
    <div style={{ padding: '16px' }}>
...
export const LGT07ReducedMotion: Story = {
  name: 'slice03 -- LGT-07 reduced motion',
  render: () => (
    <div style={{ padding: '16px' }}>
