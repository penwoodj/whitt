...
describe('NodeDetailPanel', () => {
  it('renders collapsed by default', () => {
    ...
    render(<NodeDetailPanel expanded={false} onToggle={onToggle} />)
  ...
  it('shows markdown when expanded', () => {
    const onToggle = vi.fn()
    render(<NodeDetailPanel expanded={true} onToggle={onToggle} />)
  ...
  it('renders custom markdown', () => {
    ...
    render(<NodeDetailPanel expanded={true} onToggle={onToggle} markdown={customMarkdown} />)
